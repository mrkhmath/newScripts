...
# Load the Excel file
file_path = 'C:/Users/kh_ma/Downloads/Book1.csv'
...
grades_22_23_dok1 = sum_grades(df, 'math', '1', '22-23')
grades_23_24_dok1 = sum_grades(df, 'math', '1', '23-24')
grades_22_23_dok2 = sum_grades(df, 'math', '2', '22-23')
grades_23_24_dok2 = sum_grades(df, 'math', '2', '23-24')
grades_22_23_dok34 = sum_grades(df, 'math', '3,4', '22-23')
grades_23_24_dok34 = sum_grades(df, 'math', '3,4', '23-24')
...
output_file_path = 'C:/Users/kh_ma/Downloads/AggregatedGrades.xlsx'
